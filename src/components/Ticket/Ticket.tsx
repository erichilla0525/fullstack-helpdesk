...
export default function WorkOrder() {
  ...
  return(
      <div className="flex flex-col items-center justify-between mt-3 mb-3 gap-5">
        ...
        <div className='mx-auto space-y-3 border-2'>
          {tickets.map((ticket:Ticket) => (
            <div>
              ...
              <button type="button" onClick={() => deleteTicket(ticket.id)} className="bg-pink-200 border-2 mt-3 mb-1 cursor-pointer">
                  <Trash2 size={20}/>
              </button>
            </div>
          ))}
